...
class Youths extends CI_Controller {
    public function index(){
        ...
        $data['description'] = 'There is no need to try and remember all the URLs of the sites your youths love - ClicksPicks does it for you. Simply click on the pre-verified youth-friendly site name to open a new window and instantly be taken to that site.';
